        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-xl sm:text-2xl md:mt-5 md:max-w-3xl">
              Faculty of Physical Sciences, University for Development Studies
            </p>
            <div className="mt-10 flex justify-center">
              <Link
                to="/courses"
                className="px-8 py-3 border border-transparent text-base font-medium rounded-md text-green-700 bg-white hover:bg-gray-100 md:py-4 md:text-lg md:px-10"
              >
                View Courses
              </Link>
              <Link
                to="/contact"
                className="ml-4 px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-800 md:py-4 md:text-lg md:px-10"
              >
                Contact Us
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <Link to="/courses" className="group">
              <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <FaBook className="h-12 w-12 text-green-600 mb-4" />
                <h3 className="text-xl font-medium text-gray-900 group-hover:text-green-600">Courses</h3>
            ...
            <Link to="/faculty" className="group">
              <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <FaUsers className="h-12 w-12 text-green-600 mb-4" />
                <h3 className="text-xl font-medium text-gray-900 group-hover:text-green-600">Faculty</h3>
            ...
            <Link to="/announcements" className="group">
              <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <FaBullhorn className="h-12 w-12 text-green-600 mb-4" />
                <h3 className="text-xl font-medium text-gray-900 group-hover:text-green-600">Announcements</h3>
                <p className="mt-2 text-sm text-gray-500 text-center">Stay updated with the latest department news</p>
              </div>
            </Link>
            <Link to="/events" className="group">
              <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <FaCalendarAlt className="h-12 w-12 text-green-600 mb-4" />
                <h3 className="text-xl font-medium text-gray-900 group-hover:text-green-600">Events</h3>
                <p className="mt-2 text-sm text-gray-500 text-center">
