          ...
          <div className="inline-flex rounded-md shadow-sm">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium ${
                filter === "important" ? "bg-green-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-r-md ${
                filter === "regular" ? "bg-green-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
            ...
            >
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  <div className={`flex-shrink-0 ${announcement.important ? "text-red-500" : "text-green-500"}`}>
