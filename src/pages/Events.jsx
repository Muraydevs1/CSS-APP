          ...
          <div className="inline-flex flex-wrap justify-center gap-2">
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-md ${
                filter === "all" ? "bg-green-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
            ...
            <button
              type="button"
              className={`px-4 py-2 text-sm font-medium rounded-md ${
                filter === "seminar" ? "bg-green-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
            ...
            <button
              type="button"
              className={`px-4 py-2 text-sm font-medium rounded-md ${
                filter === "workshop" ? "bg-green-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
            ...
            <button
              type="button"
              className={`px-4 py-2 text-sm font-medium rounded-md ${
                filter === "competition" ? "bg-green-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
            ...
            <button
              type="button"
              className={`px-4 py-2 text-sm font-medium rounded-md ${
                filter === "career" ? "bg-green-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
